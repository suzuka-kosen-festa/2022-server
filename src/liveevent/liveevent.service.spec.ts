...
describe('LiveeventService', () => {
   ...
   it("update",async () => {
      const eventData : Prisma.LiveEventUpdateInput = {title: "てすとイベント1", descriptions: "説明1", date : "2022-10-30 12:10", venue: "会場1", start_time: "2022-10-30 12:10", end_time: "2022-10-30 13:10", stage: "main"}
